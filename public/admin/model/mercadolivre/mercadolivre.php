		  ...
		  if($mercaInfo)
				...
				{  
				  ...
				  if(!$shippingFound) {
				        ...
				        $dimensions = '';
				        if((int)$product['length'] && (int)$product['width'] && (int)$product['height'] && (int)$product['weight']) {
				          $dimensions = (int)$product['length']."x".(int)$product['width']."x".(int)$product['height'].",".(int)$product['weight'];
				        } 
				        
				        if ($mercadolivre_shipping_alter == 'me10') {
				        ...
				        if ($mercadolivre_shipping_alter == 'me11') {
				        ...
				        if ($mercadolivre_shipping_alter == 'me20') {
				        ...
				        if ($mercadolivre_shipping_alter == 'me21') {
